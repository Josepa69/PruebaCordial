...
Public Class frmLiberacionBloqueados
    ...
    Private Sub btnLiberar_Click(sender As Object, e As EventArgs) Handles btnLiberar.Click
        ...
        Else
            ...
            If strIDs = "" Then
                MsgBox("Debe seleccionar registros a liberar", vbInformation, "CORDIALPHONE")
                dtgRegistros.Focus()
                Exit Sub
            End If
        ...
        If chkEjecutivos.Checked = True Then
            ...
            If chkListEjecutivos.CheckedItems.Count = 0 Then
                MsgBox("Debe seleccionar ejecutivos a asignar con la opcion de Asignar Ejecutivos", vbExclamation, "CORDIALPHONE")
