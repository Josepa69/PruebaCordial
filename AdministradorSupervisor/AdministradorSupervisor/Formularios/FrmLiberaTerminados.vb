...
Public Class FrmLiberaTerminados
    '   Dim cnn As New SqlConnection("data source = 190.96.5.67; initial catalog = Global; User Id= USER_PROCALL; Password=rbMv2YawFI")
    ...
    Private Sub ListaCargaBase()
        ...
        Catch ex As Exception
            MsgBox("Error Llenar Grilla CargaBase" & vbNewLine & ex.Message, MsgBoxStyle.Critical, "CordialPhone")
        Finally
            cnn.Close()
        End Try
    End Sub
    ...
    Private Sub CargaCombo(ByRef Combo As ComboBox, ByVal query As String)
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Error Llenar Combo para la consulta " & query & vbNewLine & ex.Message, MsgBoxStyle.Critical, "CordialPhone.")
        End Try
    ...
    Private Sub CargaComboTipoBase(ByRef Combo As ComboBox, ByVal query As String)
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Error Llenar Combo Tipo Base" & vbNewLine & ex.Message, MsgBoxStyle.Critical, "CordialPhone.")
        End Try
    ...
    Private Sub LlenaGrilla()
        ...
        Catch ex As Exception
            MsgBox("Error Llenar Grilla" & vbNewLine & ex.Message, MsgBoxStyle.Critical, "CordialPhone.")
        Finally
            cnn.Close()
        End Try
    End Sub
    ...
    Private Sub LlenaGrillaLog()
        ...
        Catch ex As Exception
            MsgBox("Error Llenar Grilla LOG" & vbNewLine & ex.Message, MsgBoxStyle.Critical, "CordialPhone.")
        Finally
            cnn.Close()
        End Try
    End Sub
    ...
    Private Sub GrabaLiberacion()
        ...
        Catch ex As Exception
            ...
            MsgBox("No se pudo liberar" & vbNewLine & ex.Message, vbInformation, "CORDIALPHONE")
        Finally
            cnn.Close()
    ...
    Private Sub IngresaBitacora(ByVal bitacora As clsBitacora)
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@ipEquipo", bitacora.Ip_Equipo)
            cmd.ExecuteNonQuery()

            myTransaction.Commit()

        Catch ex As Exception
            MsgBox("Error en ingreso de Bitacora" & vbNewLine & ex.Message, vbExclamation, "CORDIALPHONE")
            myTransaction.Rollback()
        Finally
            cnn.Close()
        End Try
    ...
    Private Sub LiberarDetallados(ByVal strIDs As String)
        ...
        Catch ex As Exception
            MsgBox("Ha ocurrido un error al intentar la liberación de los registros" & vbNewLine & ex.Message, vbExclamation, "CORDIALPHONE")
            myTransaction.Rollback()
        Finally
            cnn.Close()
    ...
    Private Sub btnActualizarDetalle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActualizarDetalle.Click
        ...
        Else
            MsgBox("No se ha habilitado ninguna opción de filtro.", MsgBoxStyle.Information, "CordialPhone.")
        End If
