...
Public Class frmCambioEyO
    Dim cnn As New SqlConnection("data source = 190.96.5.67; initial catalog = CALIDAD; User id= cp; password=Cordial.passs ")
    Dim cnn2 As New SqlConnection("data source = 190.96.5.67; initial catalog = BASE_GENERAL_CORDIAL; User id= cp; password=Cordial.passs ")
