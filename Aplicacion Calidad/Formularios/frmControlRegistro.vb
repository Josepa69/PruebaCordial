...
Public Class frmControlRegistro
    ...
    Dim cnn2 As New SqlConnection("data source = 190.96.5.67; initial catalog = CALIDAD; User Id= cp; Password=Cordial.passs")
    ...
    Public Sub ListarDatosCliente(ByVal id As Integer, ByVal idInstancia As Integer)
        ...
        Dim cnn As New SqlConnection("data source = 190.96.5.67; initial catalog = BDD_" + Microsoft.VisualBasic.Right("00" + idCRMBase, 3) + "; User Id= cp; Password=Cordial.passs")
    ...
    Private Sub EscucharGrabacion(ByVal idCrm As Integer, ByVal fecha As String, ByVal nombreGrab As String)
        Dim tabla As New DataTable
        Dim cmd As New SqlCommand
        Dim sql As String = ""
        Dim dia As String
        ...
        Dim esc As String = "\\190.96.5.67\Audios_CRM\CRM_" + nomFinalcrm + "\" + anio.ToString + "\" + Mes.ToString + "\" + dia.ToString + "\" + nombreGrab + ".mp3"
        crm = nomFinalcrm

        If File.Exists(esc) Then
            Process.Start(esc)
        Else
            Dim esc2 As String = "\\190.96.5.67\Audios_CRM_No_Ventas\CRM_" + nomFinalcrm + "\" + anio.ToString + "\" + Mes.ToString + "\" + dia.ToString + "\" + nombreGrab + ".mp3"
            If File.Exists(esc2) Then
                Process.Start(esc2)
            Else
                MsgBox("No existe Grabacion para Este Registro", vbExclamation, "Grabacion No Encontrada")
            End If
        End If
    ...
    Private Sub btnEscuchar_Click_1(sender As Object, e As EventArgs) Handles btnEscuchar.Click
        EscucharGrabacion(idCRMBase, fechaGrabacion, NombreGrabacion)
    ...
    Private Sub GuardarCalidad(user As String, subMoti As Integer, IdInstancia As Integer, crm As Integer, idRegistro As Integer, rut As Integer, fec As String, ejec As String, ecalidad As String, obs As String)
        ...
        obs.Replace(" ", " ")
        cnn2.Open()
        myTransaction = cnn2.BeginTransaction()
        cmd.CommandType = CommandType.StoredProcedure


        sql = "Entidad.pa_InsertarAsigCalidad"
    ...
    Private Sub ActualizarDatosCliente_Click(sender As Object, e As EventArgs) Handles ActualizarDatosCliente.Click
        ...
        frmModificarRegistro.ShowDialog()
